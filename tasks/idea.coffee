        ...
        if target == "swf" then # ignore
            ...
            if !airModule
                ...
                actions.unshift (onComplete) ->
                    ...
                    idea.createAppXmlIfNecessary airModule.args, airModule.path, data.version, data.air, target, (error, result)->
                ...
                if testSwf && data.test
                    ...
                    actions.unshift (onComplete) ->
                        ...
                        idea.createAppXmlIfNecessary testAirModule.args, testAirModule.path, data.version, data.air, target, (error, result)->
                            if error then onComplete(error)
                            else 
